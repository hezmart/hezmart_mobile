...
class AppTheme extends ChangeNotifier {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      headlineLarge: TextStyle(fontSize: 40.0.sp, fontWeight: FontWeight.bold),
    ...
    colorScheme: ColorScheme(
      ...
      error: Colors.red,
      onBackground: Color(0xff48484A),
      onError: Colors.white,


      ///
      onPrimary: Color(0xff48484A),
      onSecondary:  Color(0xff9b0000),
      ///
      onSurface: Colors.black,
      surface: Pallets.white,
    ),
  );

  static final ThemeData darkTheme = lightTheme.copyWith(
    brightness: Brightness.dark,
    primaryColor: Pallets.grey60,
    hintColor: Colors.lightBlueAccent,
    scaffoldBackgroundColor: Pallets.bgDark,
    appBarTheme: const AppBarTheme(
      color: Pallets.bgDark,
    ...
    textTheme: lightTheme.textTheme
        .apply(bodyColor: Colors.white70, displayColor: Pallets.white),
    ...
    colorScheme: lightTheme.colorScheme.copyWith(
        ...
        surface: Pallets.darkGrey,
        onBackground: Pallets.white,
        primary: Pallets.primaryDark,
        onPrimary: Pallets.grey90,
        onSecondary:Colors.white,
    onSurface: Pallets.grey75),
  );
}
